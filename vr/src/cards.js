...
export function createInspection(parent,{position=[0,.72,-.08],controlKind='inspection-action'}={}){
 ...
 const mesh=new THREE.Mesh(new THREE.PlaneGeometry(.72,1.08),material);mesh.renderOrder=200;group.add(mesh);
