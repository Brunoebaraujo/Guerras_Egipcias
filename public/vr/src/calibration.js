...
export function createCalibration(scene,world,onChange){
  ...
  function draw(){
    ...
    ctx.fillStyle='#f0cf8c';ctx.font='bold 38px sans-serif';ctx.fillText('AJUSTAR POSIÇÃO • 1.7.0',512,48);
  ...
  function current(){return {version:'1.7.0',code:placementCode(settings),settings:{...settings},eyeHeight,anchor:{...anchor},table:tableTransform(settings),hand:handTransform(settings,eyeHeight)};}
